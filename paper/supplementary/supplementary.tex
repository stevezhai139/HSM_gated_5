...
%% HSM v2 placeholder macros (HSM_gated regeneration) — see main_article.tex.
\newcommand{\TBD}[2]{\textcolor{red}{\textbf{[TBD:#1]}}\,\textcolor{gray}{\st{#2}}}
\newcommand{\TBDcell}[1]{\textcolor{red}{\textbf{[TBD:#1]}}}
\newcommand{\REMARK}[1]{\textcolor{red}{\textit{[REMARK: #1]}}}
...
\REMARK{Every numeric in Sections~XI--XIII of this supplementary
(A1--A14, A-CE1--3, scale-sensitivity tables, gate sensitivity,
$\theta$ calibration) is a v1 placeholder pending the HSM\_gated
v2 regeneration.  Do not cite these values as final; the proofs
in Sections~I--X are unaffected.}
...
SDSS              & 4{,}954 & 0.633 & 0.477 & 0.810\\
JOB-light         &     210 & 0.728 & 0.331 & 0.705\\
...
Each row is one workload at its calibrated $\thetastar$.
$N$\,=\,number of consecutive window-pairs;
$\hat{p}^{\,\mathrm{T}}_{\mathrm{stable}}$\,=\,fraction of within-phase pairs;
Bnd\,=\,$1/(1\!-\!\hat{p}^{\,\mathrm{T}}_{\mathrm{stable}})$
(asymptotic upper bound of Theorem~5);
...
$10$-block RCB across SF\,$\in\!\{0.2,1.0,3.0\}$.}\label{tab:t5-cross-supp}
\setlength{\tabcolsep}{2.5pt}
\begin{tabular}{@{}lrrrrrrr@{}}
\toprule
\textbf{Workload} & $\theta$ & $N$ &
$\hat{p}^{\,\mathrm{T}}_{\mathrm{stable}}$ & Bnd & TPR &
